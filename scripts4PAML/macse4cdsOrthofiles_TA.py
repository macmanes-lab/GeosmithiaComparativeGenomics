...
parser.add_argument('--root', default="/fungi/taruna/shared/testing_macse/", help="PATH to the directory containing CDS orthogroup files.")
parser.add_argument('--align_NT_dir', default="/fungi/taruna/shared/testing_macse/NT_aligned/", help="PATH to the directory for NT aligned CDS orthogroup files.")
parser.add_argument('--align_AA_dir', default="/fungi/taruna/shared/testing_macse/AA_aligned/", help="PATH to the directory for AA aligned CDS orthogroup files.")
